            ...
            <div className="panels-container">
                <div className="panel left-panel">
                    <div className="content">
                        ...
                        <p>Log in using your registered email and password.
Access your dashboard to book, view, or manage appointments.
</p>
                ...
                <div className="panel right-panel">
                    <div className="content">
                        ...
                        <p>Create an account with your name, email, and password.
Get instant access to book appointments and manage your profile.</p>
