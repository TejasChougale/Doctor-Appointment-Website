						...
						<div className="col-6 col-md-6 col-lg-3">
							<div className="footer-widget footer-about">
								...
								<div className="footer-about-content">
									<p className='form-text' style={{maxWidth:200}}>Doctors are essential healthcare professionals who dedicate their expertise to diagnosing, treating,
									and preventing illnesses, playing a crucial role in safeguarding and improving human well-being.</p>
								</div>
							</div>
						</div>
							...
							<div className="footer-widget footer-contact">
								...
								<div className="footer-contact-info">
									<div className="footer-address">
										...
										<p>Near Coep Hostel,Shivajinagar,Pune-411005</p>
									</div>
									<p>
