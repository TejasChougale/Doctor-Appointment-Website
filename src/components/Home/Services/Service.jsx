    ...
    return (
        <section className="container" style={{marginTop: 200, marginBottom:200}}>
            <div className='mb-5 section-title text-center'>
                <h2>Services</h2>
                <p className='m-0'>We provide comprehensive healthcare services, encompassing diagnosis, treatment, prevention, and ongoing management of your health needs.</p>
            </div>
