...
import img4 from '../../../images/doc/doc7.jpg';
import img5 from '../../../images/doc/doc1.jpg';
import img6 from '../../../images/doc/doc5.jpg';
...
const Gallery = () => {
    const imageArray = [img2,img3,img4,img5,img9,img6, img8, img7]
    return (
        <section className="gallery container">
            <div className="text-center mb-5">
                <div className="section-title mb-3">
                    <h2>Gallery</h2>
                    <p>Browse our gallery to see the comfort and care we provide every day.</p>
                </div>
            </div>
