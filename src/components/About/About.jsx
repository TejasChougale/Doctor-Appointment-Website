...
const About = () => {
    ...
    return (
        <>
            <Header />
            <SubHeader title="about us" subtitle="Our platform bridges the gap between healthcare providers and patients, making quality medical care just a click away." />
            <div className="container" style={{ marginBottom: 100, marginTop: 100 }}>
                <div className="row p-5">
                    <div className="col-lg-4">
                        <div className='section-title text-center'>
                            <h2 className='text-uppercase'>Our Doctors Acheivement</h2>
                            <p className='form-text m-0'>Excellent Pride</p>
                        </div>
                        <p className='mt-3'>Our experienced doctors are nationally recognized for their medical expertise. With awards, research contributions, and successful treatments, they bring top-quality care to every patient.</p>
                    </div>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'> Compassionate, skilled, and dedicated professionals ready to care for you.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-6 offset-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'>We’re here not just to treat, but to listen, guide, and care for every step of your health journey.</p>
                        </div>
                    </div>
                </div>
